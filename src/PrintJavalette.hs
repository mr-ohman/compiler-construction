...
instance Print TopDef where
  prt i e = case e of
   ...
   StructDef id strdecls -> prPrec i 0 (concatD [doc (showString "struct") , prt 0 id , doc (showString "{") , prt 0 strdecls , doc (showString "}") , doc (showString ";")])
   TypeDef id0 id -> prPrec i 0 (concatD [doc (showString "typedef") , doc (showString "struct") , prt 0 id0 , doc (showString "*") , prt 0 id , doc (showString ";")])
   ClassDef id classdecls -> prPrec i 0 (concatD [doc (showString "class") , prt 0 id , doc (showString "{") , prt 0 classdecls , doc (showString "}")])
   ExtendDef id0 id classdecls -> prPrec i 0 (concatD [doc (showString "class") , prt 0 id0 , doc (showString "extends") , prt 0 id , doc (showString "{") , prt 0 classdecls , doc (showString "}")])
...
instance Print StrDecl where
  prt i e = case e of
   StrDecl type' ids -> prPrec i 0 (concatD [prt 0 type' , prt 0 ids])
...
instance Print ClassDecl where
  prt i e = case e of
   ClassVar strdecl -> prPrec i 0 (concatD [prt 0 strdecl , doc (showString ";")])
   Method type' id args block -> prPrec i 0 (concatD [prt 0 type' , prt 0 id , doc (showString "(") , prt 0 args , doc (showString ")") , prt 0 block])
...
instance Print Stmt where
  prt i e = case e of
   ...
   Ass variable expr -> prPrec i 0 (concatD [prt 0 variable , doc (showString "=") , prt 0 expr , doc (showString ";")])
   Incr variable -> prPrec i 0 (concatD [prt 0 variable , doc (showString "++") , doc (showString ";")])
   Decr variable -> prPrec i 0 (concatD [prt 0 variable , doc (showString "--") , doc (showString ";")])
...
instance Print Type where
  prt i e = case e of
   ...
   Custom id -> prPrec i 1 (concatD [prt 0 id])
   Array type' -> prPrec i 0 (concatD [prt 0 type' , doc (showString "[]")])
   String  -> prPrec i 0 (concatD [doc (showString "_string")])
   Fun type' types -> prPrec i 0 (concatD [prt 0 type' , doc (showString "(") , prt 0 types , doc (showString ")")])
   Pointer id -> prPrec i 0 (concatD [prt 0 id , doc (showString "*")])
   Wildcard  -> prPrec i 0 (concatD [doc (showString "_*_")])
...
instance Print Variable where
  prt i e = case e of
   VIdent id -> prPrec i 1 (concatD [prt 0 id])
   VIndex id arrayindexs -> prPrec i 1 (concatD [prt 0 id , prt 0 arrayindexs])
   VDeref variable0 variable -> prPrec i 0 (concatD [prt 0 variable0 , doc (showString "->") , prt 1 variable])
   VAnnDeref type' variable0 variable -> prPrec i 0 (concatD [doc (showString "(") , prt 0 type' , doc (showString ")") , prt 0 variable0 , doc (showString "->") , prt 1 variable])


instance Print ArrayIndex where
  prt i e = case e of
   AIndex expr -> prPrec i 0 (concatD [doc (showString "[") , prt 0 expr , doc (showString "]")])
...
instance Print Expr where
  prt i e = case e of
   EVar variable -> prPrec i 7 (concatD [prt 0 variable])
   ELitInt n -> prPrec i 7 (concatD [prt 0 n])
   ELitDoub d -> prPrec i 7 (concatD [prt 0 d])
   ...
   ENewClass id -> prPrec i 7 (concatD [doc (showString "new") , prt 0 id])
   ENewArr type' arrayindexs -> prPrec i 7 (concatD [doc (showString "new") , prt 1 type' , prt 0 arrayindexs])
   ENull type' -> prPrec i 7 (concatD [doc (showString "(") , prt 0 type' , doc (showString ")null")])
   ...
   EDot expr0 expr -> prPrec i 6 (concatD [prt 6 expr0 , doc (showString ".") , prt 7 expr])
   ...
   Ann type' expr -> prPrec i 0 (concatD [doc (showString "(") , prt 0 type' , doc (showString ")") , prt 0 expr])
   ELength  -> prPrec i 6 (concatD [doc (showString "_length")])
   ObjCast type' expr -> prPrec i 0 (concatD [doc (showString "(") , prt 0 type' , doc (showString ")") , prt 0 expr])
